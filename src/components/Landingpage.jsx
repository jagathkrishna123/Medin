...
const Landingpage = () => {
  ...
  const images = [
    ...
    "https://plus.unsplash.com/premium_photo-1681996572462-21182f671b39?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ];
    ...
    <div className="w-full min-h-screen flex flex-col font-poppins">
      ...
      <div className="bg-[#566077] text-gray-200 text-xs py-2.5 px-4 md:px-12 flex justify-between items-center">
        ...
        <div className="hidden sm:flex space-x-2.5">
          ...
          <a
            href="#"
            className="bg-white text-[#566077] p-1.5 rounded-full hover:bg-gray-200 transition"
          >
          ...
          <a
            href="#"
            className="bg-white text-[#566077] p-1.5 rounded-full hover:bg-gray-200 transition flex items-center justify-center"
          >
            <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12.52 14.5c-.3 0-.6.1-.8.2-.8-.7-1.4-1.6-1.7-2.6.4-.3.7-.7.7-1.2 0-1-.8-1.8-1.8-1.8s-1.8.8-1.8 1.8c0 .5.3.9.7 1.2-.3 1-.9 1.9-1.7 2.6-.2-.1-.5-.2-.8-.2-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2c0-.3 0-.6-.1-.8.8-.6 1.8-.9 2.8-.9.9 0 1.9.3 2.7.9-.1.2-.1.5-.1.8 0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2z" />
            </svg>
          </a>
        </div>
      </div>
      ...
      <nav className="bg-white py-4 px-4 md:px-12 flex justify-between items-center shadow-sm">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-[26px] font-bold text-[#3a3a3a] tracking-tight">
            medera
          </span>
        </div>
      ...
      >
        ...
        >
          <div className="flex items-center justify-between p-5 border-b border-gray-100">
            ...
            <button
              onClick={() => setIsMobileMenuOpen(false)}
              className="p-1.5 rounded-full text-gray-500 hover:bg-gray-100 hover:text-red-500 transition-colors"
            >
              <X className="w-6 h-6" />
            </button>
          </div>
          ...
          <div className="flex flex-col py-4 overflow-y-auto">
            <a
              href="#"
              onClick={() => setIsMobileMenuOpen(false)}
              className="px-6 py-3.5 text-[14px] font-bold text-gray-700 hover:bg-gray-50 hover:text-blue-500 transition border-b border-gray-50"
            >
              ABOUT US
            </a>
            <a
            ...
            <a
              href="#"
              onClick={() => setIsMobileMenuOpen(false)}
              className="px-6 py-3.5 text-[14px] font-bold text-gray-700 hover:bg-gray-50 hover:text-blue-500 transition"
            >
              CONTACTS
            </a>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <h2 className="text-[38px] md:text-[44px] font-bold text-[#444444] leading-tight mb-6">
              ...
              <span className="text-[#566077]">of Medicine</span>
            </h2>
            <p className="text-gray-500 text-[16px] leading-relaxed mb-8">
              ...
              injury or inflammation. This process involves a variety of
              techniques including a minimally invasive procedure conducted
              right in our clinic.
            </p>
            ...
            <ul className="space-y-4 mb-10">
              <li className="flex items-start">
                ...
                <span className="text-gray-600 text-[15px]">
                  Equipped for all stages of care, from prevention to
                  rehabilitation
                </span>
              </li>
              <li className="flex items-start">
                <Check className="w-5 h-5 text-[#566077] mt-0.5 mr-3 flex-shrink-0" />
                <span className="text-gray-600 text-[15px]">
                  Quality assessment program helps ensure smooth, effective
                  operation
                </span>
              </li>
              <li className="flex items-start">
            ...
            <a
              href="#"
              className="inline-flex items-center text-[#566077] font-bold hover:text-[#424b61] transition"
            >
              Booking a visit{" "}
          ...
          <div className="lg:w-1/2 relative w-full">
            ...
            <div className="absolute bottom-0 left-0 bg-[#65769f] hover:bg-[#526081] transition cursor-pointer flex items-center px-8 py-5 rounded-tr-md">
              <span className="text-white font-semibold text-sm mr-4">
                Watch Video
              </span>
              <div className="bg-white rounded-full p-3 flex items-center justify-center">
                <svg
                  className="w-4 h-4 text-[#65769f] ml-1"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
                    fillRule="evenodd"
                    d="M4.16 4.16l11.68 5.84-11.68 5.84V4.16z"
                    clipRule="evenodd"
                  />
                </svg>
              </div>
  ...
  <div className="max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-10">
    ...
    <div className="bg-[#fafafa] border border-gray-100 rounded-2xl p-10 flex flex-col justify-between">
      ...
      <section className="bg-[#f5f5f3] pt-6 overflow-hidden relative">
        {/* Watermark */}
        <div className="hidden lg:block absolute top-[90px] left-1/2 -translate-x-1/2 text-[90px] font-extrabold text-white/80 whitespace-nowrap leading-none z-0 pointer-events-none select-none">
          Why Choose Us?
        </div>

        <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-6 flex flex-col lg:flex-row items-center relative z-10">
          {/* Left Image */}
          <div className="w-full lg:w-1/2 flex items-end justify-center lg:justify-start self-stretch order-2 lg:order-1">
            <img
              src={whyChooseUsImg}
              alt="Doctors"
              className="w-full max-w-[280px] sm:max-w-[350px] md:max-w-[450px] lg:w-[650px] xl:w-[800px] lg:max-w-none object-contain lg:-ml-28 mt-auto"
            />
          </div>

          {/* Right Content */}
          <div className="w-full lg:w-1/2 flex flex-col justify-center order-1 lg:order-2 lg:pl-8 mt-6 sm:mt-8 lg:mt-0 py-6">
            <div className="text-center flex flex-col items-center">
              <p className="text-[#5b6799] font-semibold tracking-[2px] text-[14px] uppercase mb-3">
                See the Difference
              </p>

              <h2 className="text-[28px] sm:text-[32px] lg:text-[36px] leading-none font-semibold text-[#444444] mb-8 sm:mb-10 lg:mb-14">
                Why Choose Us?
              </h2>
            </div>
            ...
            <div className="flex flex-col gap-8 sm:gap-10 lg:gap-12">
              {featuresData.map((feature) => (
                <div
                  key={feature.id}
                  className="flex items-start gap-4 sm:gap-5 lg:gap-7"
                >
                  {/* Number Circle */}
                  <div className="w-[65px] h-[65px] sm:w-[75px] sm:h-[75px] lg:w-[82px] lg:h-[82px] rounded-full bg-white cursor-pointer hover:bg-[#5C6895] transition duration-300 flex items-center justify-center shrink-0 shadow-sm">
                    <span className="text-[24px] sm:text-[26px] lg:text-[28px] font-bold text-[#5b6799] hover:text-white transition duration-300">
                      {feature.number}
                    </span>
                  </div>
                  ...
                  <div className="pt-1 flex-1">
                    <h3 className="text-[18px] sm:text-[19px] lg:text-[20px] font-bold text-[#2d3648] mb-2 sm:mb-2.5 lg:mb-3">
                      {feature.title}
                    </h3>

                    <p className="text-[#7b7b7b] text-[15px] sm:text-[15.5px] lg:text-[16px] leading-[1.7] sm:leading-[1.8] lg:leading-[1.9] max-w-[520px]">
                      {feature.description}
                    </p>
                  </div>
                </div>
      ...
      <section className="py-24 bg-white w-full flex flex-col items-center overflow-hidden">
        <div className="text-center max-w-2xl mb-10 px-4">
          ...
          <p className="text-[#787878] text-[16px] leading-relaxed max-w-[550px] mx-auto">
            We offer highly specialised medical care, on one site, from some of
            the foremost national and international specialists in their fields
            of medicine.
          </p>
        </div>
        ...
        <div className="mb-14">
          <div className="relative w-[280px]">
            <select className="w-full appearance-none bg-white border border-slate-200 rounded-xl px-5 py-3.5 text-[16px] font-medium text-slate-700 shadow-sm hover:border-slate-300 focus:outline-none transition-all duration-300 cursor-pointer">
    ...
    "
      ...
      <section className="w-full bg-[#fdfdfd] border-t border-gray-100 mt-20 flex justify-center overflow-hidden">
        <div className="flex flex-col lg:flex-row w-full max-w-[1400px]">
          ...
          <div className="w-full lg:w-1/2 min-h-[650px] py-16 px-8 lg:px-16 flex flex-col justify-center relative overflow-hidden bg-transparent">
            {/* Background Pattern */}
            <div
            ...
            <div className="relative z-10 max-w-[500px]">
              ...
              <div className="text-[#65769f] mb-6">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-12 h-12 text-[#65769f]"
                >
              ...
              {/* Dynamic Testimonial */}
              <p className="text-[17px] md:text-[19px] text-[#555555] font-serif italic leading-[1.8] mb-8 transition-all duration-500">
              ...
              <p className="text-[13px] text-gray-500 mb-12">
                ...
                <span className="text-[#65769f] font-medium">
              ...
              <div className="flex gap-4">
                <button
                  onClick={prevSlide}
                  className="w-9 h-9 rounded-full bg-white border border-gray-100 flex items-center justify-center hover:bg-gray-50 transition text-gray-400 shadow-[0_2px_10px_rgba(0,0,0,0.03)]"
                >
                  <svg
                    className="w-3.5 h-3.5"
                    fill="none"
                ...
                <button
                  onClick={nextSlide}
                  className="w-9 h-9 rounded-full bg-white border border-gray-100 flex items-center justify-center hover:bg-gray-50 transition text-[#65769f] shadow-[0_2px_10px_rgba(0,0,0,0.03)]"
                >
                  <svg
                    className="w-3.5 h-3.5"
                    fill="none"
...
"
                style={{
                  transform: `translateX(calc(-${eventsIndex} * (100% + 24px)))`,
                }}
              >
                {/* Image */}
          ...
          <div className="w-full lg:w-[45%] flex flex-col justify-center py-24 px-8 lg:pl-[12%] lg:pr-12 gap-12 z-10 relative">
            ...
            <div className="flex items-start gap-6">
              <div className="text-[#7283a9] font-bold leading-none flex items-start w-[120px]">
                <span className="text-[56px] md:text-[48px] tracking-tighter">
                  150
                </span>
                <span className="text-[20px] md:text-[24px] mt-2 ml-1">K</span>
              </div>
              <div className="flex flex-col pt-3 flex-1">
                <h4 className="text-white font-bold text-[15px] mb-2 tracking-wide">
                  Cured Patients
                </h4>
                <p className="text-gray-300 text-[13px] leading-[1.8] max-w-[280px]">
                  For over 15 years, we have delighted our customers and provide
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex flex-col pt-3 flex-1">
                ...
                <p className="text-gray-300 text-[13px] leading-[1.8] max-w-[280px]">
                  Absolutely all our clients are ready to assure you of the high
          ...
          <div className="w-full lg:w-[55%] relative flex flex-col items-center justify-center text-center py-28 px-8 z-0 min-h-[500px]">
            ...
            <div className="relative z-10 flex flex-col items-center max-w-[480px]">
              ...
              <p className="text-gray-200 text-[14px] mb-8 font-light tracking-wide">
                You can now book a limited amount of doctors' appointments
                online
              </p>
              <button className="bg-[#65769f] hover:bg-[#526081] text-white px-8 py-3.5 rounded-full text-[13px] font-bold transition duration-300 flex items-center gap-2 shadow-lg">
                ...
                <span className="text-[16px] font-normal">&rarr;</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center px-4 md:px-12">
          ...
          <div className="w-full lg:w-[55%] flex flex-col justify-center py-12 lg:py-28 lg:pl-16 order-1 lg:order-2 z-10">
            <h2 className="text-[32px] md:text-[40px] font-bold text-[#3c4456] mb-4 tracking-tight leading-tight">
              Looking for a{" "}
              <span className="text-[#65769f]">Certified Doctor?</span>
            </h2>
          ...
          <div className="flex flex-col w-full md:w-[35%]">
            <div className="flex items-center gap-2 mb-8">
              ...
              >
                ...
                />
                <path
                  d="M3 10h3l2.5-4 3.5 9 2.5-7 2 2h4"
                  stroke="#1a3461"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <span className="text-[28px] font-bold text-[#3c4456] tracking-tight">
                medera
              </span>
            </div>
            ...
            <div className="flex items-center border border-gray-200 rounded-[4px] overflow-hidden bg-white px-4 py-3 mb-8 w-full max-w-[320px] shadow-sm">
              ...
              />
              <svg
                className="w-4 h-4 text-[#65769f] shrink-0"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
          ...
          <div className="flex flex-col w-full md:w-[35%]">
            ...
            <div className="flex flex-col gap-6 mt-2">
              <div className="flex items-start gap-4">
                <svg
                  className="w-4 h-4 text-[#65769f] mt-1 shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <div className="flex flex-col">
                  ...
                  <button className="bg-[#65769f] hover:bg-[#526081] text-white text-[12px] font-medium px-4 py-1.5 rounded-full transition-colors w-fit flex items-center gap-1.5 shadow-sm">
                    ...
                    <span className="text-[14px] font-normal">&rarr;</span>
                  </button>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-[#65769f] font-bold text-[13.5px]">
                  ...
                  <br />
                  <span className="text-gray-400 font-normal text-[13px] mt-1 block">
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-[#65769f] font-medium text-[14px]">
                  info@medera.net
                </p>
              </div>
            </div>
